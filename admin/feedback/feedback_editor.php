	                ...
	                <table class="table">
							 <tr>
							  <td>  
								 ...
								 <form name="frm_feedback" method="post"  enctype="multipart/form-data" onSubmit="return checkRequired();">			
								  <div class="portlet-body">
						         <div class="table-responsive">	
					                <table class="table">
										 <tr>
...
<select  name="users_id" id="users_id"   class="form-control-static">
	...
	?> 
						 ...
						 <td>Topic</td>
						 <td>
						    <input type="text" name="topic" id="topic"  value="<?=$topic?>" class="form-control-static">
						 </td>
				     </tr><tr>
						 <td valign="top">Message</td>
						 <td>
						    <textarea name="message" id="message"  class="form-control-static" style="width:200px;height:100px;"><?=$message?></textarea>
						 </td>
				     </tr><tr>
						 <td>Date Created</td>
						 <td>
