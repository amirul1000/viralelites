...
<div class="form-container">
  ...
  <div class="container2 expand" style="background-color: #1f5a81;"><span class="expand_button button" id="modalPodYes">+</span>
    <div class="content2">
      <div class="head">
        <h6>Power Service</h6>
                  ...
                  <div class="container-fluid">
                    ...
                    <div class="row">
                      <div class="col-xs-12 chooseLikeType" style="margin-bottom: 30px;">
                        ...
                        <div class="btn-group bootstrap-select form-control">  <select class="selectpicker form-control" data-container="body" id="selType" name="selType" data-style="mdl-color--light-blue-400 mdl-color-text--white" tabindex="-98">
                          <option value="Like" data-icon="fa fa-heart" selected="selected">&nbsp; Likes Only</option>
                    ...
                    <div class="row">
                      <div class="col-xs-12 providesAccount" style="margin-bottom: 20px;">
                        ...
                        <div class="btn-group bootstrap-select form-control">  <select class="selectpicker form-control" data-style="mdl-color--grey-100 mdl-color-text--black" data-container="body" id="selNiche" name="selNiche" data-size="6" tabindex="-98">
                          <option value="viral" data-icon="fa fa-star-half-o" selected="selected">&nbsp; Viral &amp; Others</option>
